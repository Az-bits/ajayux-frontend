...
const Default = () => {
	...
	return (
		<Fragment>
			<Container fluid={true} className='product-wrapper mt-2'>
				<div className='product-grid'>
					<div className='feature-products'>
						...
						<Row className='search-person'>
							...
							<Col xl='6' md='6'>
								<Form>
									<div className='m-4 search-product search-person'>
										<Input className='form-control' type='text' placeholder='Buscar por nombre' defaultValue={searchKeyword} onChange={(e) => handleSearchKeyword(e.target.value)} />
					...
					<div className='product-wrapper-grid p-12'>
